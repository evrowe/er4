      ...
      <div className='container main-content'>
        <div className='row'>
          <div className='column column-67 column-offset-16'>
            ...
            <p>I a javascript-focused web developer, living in Portland, OR. I take pride in my ability to create living web experiences that bring joy to their users and owners alike.</p>
            ...
            <p>Do not ask me about Magento or anything e-commerce releated; if that's what you want, I am not your guy.</p>
            <h2>My Background</h2>
